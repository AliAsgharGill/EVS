        ...
        <>
            ...
            <footer className="bg-white rounded-lg w-full shadow dark:bg-gray-300 ">
                <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
                    ...
                    <span className="block text-sm text-gray-500 sm:text-center dark:text-gray-900">© 2024 <a href="https://flowbite.com/" className="hover:underline">Election Voting System™</a>. All Rights Reserved.</span>
                </div>
            </footer>
