            ...
            <nav className="bg-white dark:bg-gray-300 fixed w-full z-20 top-0 start-0 border-b border-gray-200 dark:border-gray-300">
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    ...
                    <div className="flex md:order-2 md:space-x-0 rtl:space-x-reverse">
                        ...
                        <NavLink to={'/login'} type="button" className="text-white bg-[#F09A3E] hover:bg-[#F09A3E] focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-gray-500 dark:hover:bg-gray-800 dark:focus:ring-[#F09A3E]">Login</NavLink>
                        <span className="w-5"></span>

                        <NavLink to={'/signup'} type="button" className="text-white bg-[#F09A3E] hover:bg-[#F09A3E] focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-gray-500 dark:hover:bg-gray-800 dark:focus:ring-[#F09A3E]">Signup</NavLink>
